...
description: 'Authenticate API requests using Bearer tokens. Public key (pk_) for client-side SDK, secret key (sk_) for server-side with optional IP fraud prevention. Covers test vs live modes and API playground usage'
---
