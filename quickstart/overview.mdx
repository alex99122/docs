---
title: "Overview"
description: "Complete Payviox payment flow: session creation, customer redirect to secure payment page, payment processing, webhook notification, and customer return. Includes sequence diagram"
icon: "lightbulb"
---
