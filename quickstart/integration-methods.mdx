...
description: "Choose between JavaScript SDK (frontend, 5-10 min setup, redirect or iframe mode) and REST API (backend, any language, full control). Decision guide based on tech stack and requirements"
icon: "code-compare"
---
