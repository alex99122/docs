...
description: "Simplest SDK integration. Call createSession() with redirect:true to send customers to the Payviox-hosted payment page. Full PCI compliance, no backend needed"
