...
description: "Embed the Payviox payment form directly in your page using an iframe. Requires domain whitelisting in dashboard. Configure width, height, border, and background transparency via iframeConfig"
icon: "window"
---
