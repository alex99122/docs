---
title: "createSession()"
description: "SDK method createSession(sessionParameters, options). Takes amount, currency, customer, items, paymentMethodId, order_id. Options: redirect (boolean), iframeMode (boolean), iframeConfig. Returns session ID or void on redirect. Supports direct provider redirect"
icon: "plus-circle"
---
