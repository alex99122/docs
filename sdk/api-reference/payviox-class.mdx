...
|-----------|------|----------|-------------|
| `token` | `string` | ✅ Required | Your Payviox API token. Obtain this from your dashboard at [dashboard.payviox.com](https://dashboard.payviox.com). Use test tokens (`pk_test_...`) for development and live tokens (`pk_live_...`) for production. |
