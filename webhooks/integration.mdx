...
description: 'Receive HTTP POST webhook notifications for payment events (succeeded, pending_review, declined, refunded, expired, incomplete). Includes HMAC-SHA256 signature verification, full payload structure, retry policy (4 attempts), and idempotency handling'
---
