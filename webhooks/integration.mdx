...
<Info>
  Webhooks are essential for keeping your application synchronized with payment statuses. Configure your webhook URL in the [Payviox Dashboard](https://dashboard.payviox.com) under **Settings** > **Webhooks**.
</Info>
...
<Steps>
  ...
  <Step title="Add URL to Dashboard">
    Go to your [Payviox Dashboard](https://dashboard.payviox.com) and navigate to **Settings** > **Webhooks**
  </Step>
...
- Check the [Webhook Logs](https://dashboard.payviox.com/webhooks) in your dashboard
